...
namespace Shopping.Aggregator.Controllers
{
    ...
    {
        private readonly ICatalogServicecs _catalogService;
        private readonly IBasketService _basketService;
        private readonly IOrderService _orderService;

        public ShoppingController(ICatalogServicecs catalogService, IBasketService basketService, IOrderService orderService)
        {
